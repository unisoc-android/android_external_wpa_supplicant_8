...
extern "C"
{
	...
	void wpas_hidl_notify_offload_roam(struct wpa_supplicant *wpa_s, const char *reason);
#ifdef CONFIG_WAPI
	void wpas_hidl_notify_wapi_disconnect(struct wpa_supplicant *wpa_s, const char *reason);
#endif
...
static inline void wpas_hidl_notify_offload_roam(struct wpa_supplicant *wpa_s, const char *reason)
{
}
static inline void wpas_hidl_notify_wapi_disconnect(struct wpa_supplicant *wpa_s, const char *reason)
{
}
