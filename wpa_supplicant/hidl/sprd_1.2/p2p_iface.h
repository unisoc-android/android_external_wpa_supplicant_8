...
#include <vendor/sprd/hardware/wifi/supplicant/1.2/ISupplicantP2pIface.h>
...
public:
	...
	Return<void> setParamToP2pSupplicant(
	    const hidl_string& key, const hidl_string& value,
	    setParamToP2pSupplicant_cb _hidl_cb) override;
	Return<void> getParamToP2pSupplicant(
	    const hidl_string& key,
	    getParamToP2pSupplicant_cb _hidl_cb) override;
...
private:
	...
	SupplicantStatus setParamToP2pSupplicantInternal(const std::string& key, const std::string& value);
	std::pair<SupplicantStatus, uint32_t> getParamToP2pSupplicantInternal(const std::string& key);
