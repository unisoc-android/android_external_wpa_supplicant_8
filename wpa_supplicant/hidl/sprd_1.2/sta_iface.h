...
#include <vendor/sprd/hardware/wifi/supplicant/1.2/ISupplicantStaIface.h>
...
public:
	...
	Return<void> registerCallback_1_2(
	    ...
	    registerCallback_cb _hidl_cb) override;
	Return<void> registerCallback_sprd_1_2(
	    const sp<ISupplicantStaIfaceCallbackEx>& callback,
	    registerCallback_sprd_1_2_cb _hidl_cb) override;
	...
	Return<void> setParamToSupplicant(const hidl_string& key,
			const hidl_string& value, setParamToSupplicant_cb _hidl_cb) override;
...
private:
	...
	SupplicantStatus setParamToSupplicantInternal(const std::string& key, const std::string& value);
	SupplicantStatus registerCallbackInternal_sprd_1_2(const sp<ISupplicantStaIfaceCallbackEx> &callback);
